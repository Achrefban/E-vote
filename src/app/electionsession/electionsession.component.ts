...
@Component({
  selector: 'app-electionsession',
  templateUrl: './electionsession.component.html',
  styleUrls: ['./electionsession.component.scss'],
  providers: [CandidatsService, ElectionTypeService, ElectionService]
})
export class ElectionsessionComponent implements OnInit {
